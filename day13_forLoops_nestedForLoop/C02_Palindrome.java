...
public class C02_Palindrome {
    public static void main(String[] args) {
        ...
        /*
        Tersten okunusu orjinal metnin okunusu ile ayni olan metinlere palindrome denir
        Kullanicidan bir cumle veya sayi alin, palindrome olup olmadigini
        ...
        if (cumle.equalsIgnoreCase(tersCumle)){
            ...
            System.out.println("Girdiginiz cumle palindrome degil");
        }
    }
}
