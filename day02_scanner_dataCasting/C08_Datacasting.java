...
public class C08_Datacasting {
    public static void main(String[] args) {
        ...
        /*
        Eger islem yapilan tum sayilar int ise java sonucu da int olarak verir.
        Ama sayilardan biri int, digeri double olursa, sonucu genis olana otomatik cast eder.
         */
