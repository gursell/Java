...
public class C07_equals {
    public static void main(String[] args) {
        ...
        /*
        Eger iki String'in metin olarak ayni olup olmadigini kontrol etmek icin equals
        metodu kullaniriz.

        Java String'leri karsilastirirken hem metni, hem de referansi kontrol eder
